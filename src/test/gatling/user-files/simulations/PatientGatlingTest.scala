...
class PatientGatlingTest extends Simulation {
    ...
    val scn = scenario("Test the Patient entity")
        ...
        .repeat(2) {
            ...
            .post("/api/patients")
            .headers(headers_http_authenticated)
            .body(StringBody("""{"id":null, "orgId":"SAMPLE_TEXT", "firstName":"SAMPLE_TEXT", "lastName":"SAMPLE_TEXT", "gender":null, "birthDate":"2020-01-01T00:00:00.000Z", "civility":"SAMPLE_TEXT", "profession":"SAMPLE_TEXT", "note":"SAMPLE_TEXT"}""")).asJSON
            .check(status.is(201))
