...
import fr.perioline.config.audit.AuditEventConverter;
import fr.perioline.domain.PersistentAuditEvent;
...
import static fr.perioline.repository.CustomAuditEventRepository.EVENT_DATA_COLUMN_MAX_LENGTH;
