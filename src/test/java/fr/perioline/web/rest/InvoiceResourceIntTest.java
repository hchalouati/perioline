...
public class InvoiceResourceIntTest {
    ...
    public void createInvoice() throws Exception {
        ...
        assertThat(testInvoice.getOrgId()).isEqualTo(DEFAULT_ORG_ID);
        assertThat(testInvoice.getProductName()).isEqualTo(DEFAULT_PRODUCT_NAME);
    ...
    public void getAllInvoices() throws Exception {
        ...
        restInvoiceMockMvc.perform(get("/api/invoices?sort=id,desc"))
            ...
            .andExpect(jsonPath("$.[*].invoicePDF").value(hasItem(DEFAULT_INVOICE_PDF.toString())));
    }
    ...
    public void getInvoice() throws Exception {
        ...
        restInvoiceMockMvc.perform(get("/api/invoices/{id}", invoice.getId()))
            ...
            .andExpect(jsonPath("$.invoicePDF").value(DEFAULT_INVOICE_PDF.toString()));
    }
    @Test
    @Transactional
    ...
    public void updateInvoice() throws Exception {
        ...
        Invoice testInvoice = invoiceList.get(invoiceList.size() - 1);
        assertThat(testInvoice.getOrgId()).isEqualTo(UPDATED_ORG_ID);
        assertThat(testInvoice.getProductName()).isEqualTo(UPDATED_PRODUCT_NAME);
