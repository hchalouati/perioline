...
class ContactGatlingTest extends Simulation {
    ...
    val scn = scenario("Test the Contact entity")
        ...
        .repeat(2) {
            ...
            .post("/api/contacts")
            .headers(headers_http_authenticated)
            .body(StringBody("""{"id":null, "phone1":"SAMPLE_TEXT", "email1":"SAMPLE_TEXT", "phone2":"SAMPLE_TEXT", "email2":"SAMPLE_TEXT", "streetAddress":"SAMPLE_TEXT", "postalCode":"SAMPLE_TEXT", "country":"SAMPLE_TEXT", "city":"SAMPLE_TEXT", "stateProvince":"SAMPLE_TEXT"}""")).asJSON
            .check(status.is(201))
